...
def LS_grad(x,A,b):
    ...
    TODO: If we make the assumption that A is a matrix, we can clean
    up the expression below 
    """
    
    return transpose(A)*(A*x-b)
...
# Need to verify that this is the proper division - I have a feeling it isn't.  
Opt_x = B/b 
